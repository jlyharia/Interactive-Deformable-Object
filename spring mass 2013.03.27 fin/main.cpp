/**
    ...
    Tasks:
        ...
        5) simple ODEs
        5.1) include some C++11 feathers
        6) Add FPS
*/
#include <GL/glew.h>
...
{//main drawing function
    ...
    time_finish = clock();
    auto duration = double(time_finish - time_start)/CLOCKS_PER_SEC;

    cout<<setiosflags(ios::showpoint)<<setprecision(7);
    cout<<"CLOCKS_PER_SEC is:  " <<CLOCKS_PER_SEC<<endl;
    cout<<1/duration<<"  sec"<<endl;
}
